...
@property (nonatomic, copy) void(^onClickRightTwoButton)(void);
@property (nonatomic, copy) void(^onClickRightThreeButton)(void);
...
@property (nonatomic, strong) UIButton    *righTwoButton;
@property (nonatomic, strong) UIButton    *righThreeButton;
