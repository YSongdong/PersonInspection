...
//        self.backgroundColor = self.backgroundColor = RGBA(51, 51, 51, 0.3);
        ...
        [self.cancelBtn setTitleColor:[UIColor colorWithHexString:@"#a6a6a6"] forState:UIControlStateNormal];
        ...
        [self.completionBtn setTitleColor:[UIColor colorBlueTextColor] forState:UIControlStateNormal];
        ...
        line.backgroundColor = [UIColor colorLineCommonTextColor];
        self.line = line ;
        ...
        self.timeLab.text = @"选择类别";
        self.timeLab.font = Font(18);
        self.timeLab.textColor = [UIColor colorNamlCommonTextColor];
...
-(UIView*)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view{
    ...
    for(UIView *singleLine in pickerView.subviews)
    {
        ...
        {
            singleLine.backgroundColor = [UIColor colorLineCommonTextColor];
        }
    }
    ...
    label.textColor = [UIColor colorNamlCommonTextColor];
